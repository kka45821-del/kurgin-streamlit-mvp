...
.index-shell{padding-bottom:4.8rem}.index-info-card,.index-score-card{border:1px solid #aaa;border-radius:18px;background:#f7f7f7;padding:1rem;margin:0 0 1rem}.index-title,.index-subtitle{font-weight:700;font-size:1rem;margin-bottom:.55rem}.index-info-card div,.index-score-card div{font-size:.82rem;line-height:1.45}.index-hint{font-size:.64rem!important;color:#666}.index-color-section{margin:0 0 .9rem}.index-color-section summary{list-style:none;border:1px solid #aaa;border-radius:13px;background:#f7f7f7;padding:.75rem 1rem;font-weight:700;font-size:1rem;cursor:pointer}.index-color-section summary::-webkit-details-marker{display:none}.index-color-section summary:before{content:'▶ ';font-weight:700}.index-color-section[open] summary{border-color:#555;background:#dedede}.index-color-section[open] summary:before{content:'▼ '}.index-matrix-wrap{overflow-x:auto;margin:.55rem 0 1rem;border:1px solid #bcbcbc;border-radius:10px;background:#fff}.index-matrix{width:100%;border-collapse:collapse;table-layout:fixed;font-size:.72rem}.index-matrix th,.index-matrix td{border:1px solid #bcbcbc;text-align:center;padding:.5rem .25rem;vertical-align:middle}.index-matrix thead th{background:#dedede;font-weight:400}.index-matrix tbody th{font-weight:400;background:#fafafa}.index-cell-main{font-size:.72rem;line-height:1.15}.index-cell-sub{font-size:.65rem;line-height:1.15;margin-top:.18rem}.index-filter-button{position:fixed;left:50%;transform:translateX(-50%);bottom:calc(64px + env(safe-area-inset-bottom));z-index:34;width:100%;max-width:430px;border:1px solid #777;border-radius:20px 20px 0 0;background:#f3f3f3;min-height:58px;font:inherit;font-size:.92rem;color:#111}
'''
