...
<div class="tools-page">
  ...
  <div class="tools-tab-content" data-tool-panel="kurgin_index" hidden>
    <section class="tool-card"><div class="tool-kicker">Index</div><div class="tool-title">KURGIN Index</div><div class="tool-text">Индекс / ориентир для сравнения лабораторных бриллиантов. Это не точная цена конкретного камня и не финансовый индекс.</div><div class="tool-note">UX-скелет. Реальный index engine не подключён.</div></section>
  </div>
