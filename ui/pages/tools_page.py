...
<div class="tools-page">
  <div class="tools-intro">Раздел «Инструменты» собирает аналитические и сервисные сценарии KURGIN. Karo Score здесь не отдельный инструмент: это коэффициент 0–100 внутри результата KURGIN Analyzer.</div>
  <div class="tool-grid">
    <section class="tool-card"><div class="tool-kicker">Analyzer</div><div class="tool-title">KURGIN Analyzer</div><div class="tool-text">Полный анализ одного лабораторного бриллианта: Karo Score 0–100, теги, риски, сильные стороны, интерпретации и подробный анализ.</div><div class="tool-meta"><span class="tool-pill">один камень</span><span class="tool-pill">quality analysis</span><span class="tool-pill">Karo Score внутри</span></div><div class="tool-note">Не оценка цены, не сертификат, не инвестиционная рекомендация.</div></section>
