...
<section class="tool-card mass-analyzer-upload">
  <div class="tool-kicker">Шаг 1</div>
...
<section class="tool-card mass-analyzer-validation">
  <div class="tool-kicker">Шаг 2</div>
...
<section class="tool-card mass-analyzer-preview-table">
  <div class="tool-kicker">Шаг 3</div>
...
<section class="tool-card mass-analyzer-run">
  <div class="tool-kicker">Шаг 4</div>
  <div class="tool-title">Запуск анализа</div>
  <div class="analyzer-result-grid" aria-label="Mass Analyzer future summary">
...
<section class="tool-card mass-analyzer-results">
  <div class="tool-kicker">Шаг 5</div>
